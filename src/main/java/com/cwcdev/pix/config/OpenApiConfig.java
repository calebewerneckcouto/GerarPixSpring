...
public class OpenApiConfig {
	...
	public OpenAPI pixOpenAPI() {
		return new OpenAPI()
				.info(new Info().title("Pix API").description("API de gestão de Clientes e Chaves Pix").version("1.0.0")
						.contact(new Contact().name("Equipe Pix").email("cwcdev@hotmail.com").url("https://pixapi.com"))
